// ambil element yang diperlukan dari "id"
...
function checkInput (){
    ...
    typedText.forEach((word, index) => {
        if(spans[index]){
            if(word === textToType[index]){
                console.log(word === textToType[index])
    ...
    // hapus kelas jika pengguna menghapus text yang sudah diketik sebelumnya
